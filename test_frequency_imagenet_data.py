...
#saved_model_path = "./checkpoint/ResNet18/ckpt.pth_resnest50_epoch200_ori_20220502"
#saved_model_path = "./checkpoint/ResNet18/ckpt.pth_resnest50_epoch200_cutmix_20220501"
#saved_model_path = "./checkpoint/ResNet18/ckpt.pth_resnest50_epoch200_none_20220501"
...
for r in radius:
    ...
    #testset = New_Dataset(test_low,'./data/test_label.npy',transform_test)
    testset_high_4 = New_Dataset(test_high,'./data/test_label.npy',transform_test)
